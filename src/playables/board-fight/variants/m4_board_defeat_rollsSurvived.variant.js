// Rogue Defeat S4 — base hero, board stage 4, boss defeat ending.
// Run: node src/playables/board-fight/scripts/codegen.js m4_board_defeat_rollsSurvived
...
module.exports = {
  ...
  fights: {
    // Fight 1: Single snow spider — easy intro, player dominates
    spiderIntro: {
      background: 'stage4',
      enemies: [
        { enemy: 'snowSpider', skin: 'default', maxHp: 100000, melee: true },
      ],
      steps: [
    ...
    // Fight 2: 3 troll cultists — mid difficulty, player drops to ~50% HP
    // Player rage: 20+15+15+15+20+15 = 100
    trollSwarm: {
      background: 'stage4',
      enemies: [
        { enemy: 'trollCultist', skin: 'default', maxHp: 55000, melee: true, xFrac: 0.62, yFrac: 0.82 },
        { enemy: 'trollCultist', skin: 'default', maxHp: 55000, melee: true, xFrac: 0.75, yFrac: 0.72 },
        { enemy: 'trollCultist', skin: 'default', maxHp: 55000, melee: true, xFrac: 0.82, yFrac: 0.93 },
      ],
      steps: [
    ...
    // Fight 3: Elite — yeti at middle, snow spiders at top/bottom
    // Player rage: 20+15+15+15+20+15 = 100
    yetiElite: {
      background: 'stage4',
      eliteFight: true,
      enemies: [
        { enemy: 'yeti', skin: 'default', maxHp: 80000, melee: true, xFrac: 0.65, yFrac: 0.85 },
        { enemy: 'snowSpider', skin: 'default', maxHp: 50000, melee: true, xFrac: 0.78, yFrac: 0.75 },
        { enemy: 'snowSpider', skin: 'default', maxHp: 50000, melee: true, xFrac: 0.82, yFrac: 0.93 },
      ],
      steps: [
        // Round 1: player opener -> skill -> enemies respond
    ...
    // Boss fight: dragon boss at middle, troll cultists at top/bottom
    // Dragon rage: 50+50 = 100 (1 rage attack)
    // Player rage: 15+15+15+15+20 = 80 (doesn't reach 100, player dies first)
    bossDefeat: {
      background: 'stage4',
      bossFight: true,
      enemies: [
        { enemy: 'dragonBoss', skin: 'default', maxHp: 220000, melee: true, maxRage: 100, xFrac: 0.85, yFrac: 0.85 },
        { enemy: 'trollCultist', skin: 'default', maxHp: 45000, melee: true, xFrac: 0.62, yFrac: 0.75 },
        { enemy: 'trollCultist', skin: 'default', maxHp: 45000, melee: true, xFrac: 0.62, yFrac: 0.93 },
      ],
      steps: [
        // Round 1: aggressive opener -> skill -> enemies respond -> clear cultist 1
        ...
        { type: 'die', actor: 1 },
        // Round 2: dragon punishes, clear cultist 2
        ...
        { type: 'die', actor: 2 },
        // Round 3: dragon rages (50+50=100), player fights back
        ...
        // Round 4: dragon finishes the player
  ...
  events: [
    ...
    { type: 'fight', fight: 'trollSwarm' },
    { type: 'levelup' },
    { type: 'heroReward', hero: 'fireWizard' },
    { type: 'fight', fight: 'yetiElite' },
    { type: 'levelup' },
