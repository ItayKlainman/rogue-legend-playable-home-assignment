// Rogue Defeat S3 GameEnd FightsOnly — same as rogueDefeatS3GameEnd but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m3_fight_defeat_splash
