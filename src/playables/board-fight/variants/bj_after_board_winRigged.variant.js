...
// dice-blackjack (win-rigged) → blackjack end card.
//
...
//   spin 2 = 4 hops:  8 → 4  → lands on the bj tile → embedded dice-blackjack (win-rigged)
//   → blackjack end card (auto-chains; requiresRoll(endCard) === false).
// Run: node src/playables/board-fight/scripts/codegen.js bj_after_board_winRigged --skip-active
