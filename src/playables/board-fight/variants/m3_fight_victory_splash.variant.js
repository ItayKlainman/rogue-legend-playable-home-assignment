// Rogue Victory S3 GameEnd FightsOnly — same as rogueVictoryS3GameEnd but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m3_fight_victory_splash
