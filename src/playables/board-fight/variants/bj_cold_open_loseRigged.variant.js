// Combo Direction B — dice-blackjack cold-open (lose-rigged) → board → one scripted spin
...
// Run: node src/playables/board-fight/scripts/codegen.js bj_cold_open_loseRigged --skip-active
...
module.exports = {
  ...
  leadingEvents: [{ type: 'diceBlackjack', rig: 'loseRigged', music: true }],
