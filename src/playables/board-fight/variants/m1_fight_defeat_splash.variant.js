// Rogue Defeat S1 GameEnd FightsOnly — same as rogueDefeatS1GameEnd but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m1_fight_defeat_splash
...
module.exports = {
  ...
  fights: {
    // Fight 1: Single skeleton warrior — easy intro
    skeletonIntro: {
      enemies: [
    ...
    // Fight 2: 3 slimes — mid difficulty
    slimeSwarm: {
      enemies: [
    ...
    // Boss fight: defeat — king + 2 slimes, player dies
    bossDefeat: {
      bossFight: true,
      enemies: [
