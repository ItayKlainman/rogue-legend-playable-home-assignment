// Rogue Defeat FightsOnly — same as rogueDefeat but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m1_fight_defeat_rollsSurvived
...
module.exports = {
  ...
  fights: {
    ...
    // Boss fight: king + 2 slimes, player dies
    bossDefeat: {
      bossFight: true,
      enemies: [
