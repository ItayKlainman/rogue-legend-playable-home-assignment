// Combo Direction B — dice-blackjack cold-open (fair) → board → one scripted spin
...
// Run: node src/playables/board-fight/scripts/codegen.js bj_cold_open_fair --skip-active
...
module.exports = {
  ...
  leadingEvents: [{ type: 'diceBlackjack', rig: 'fair', music: true }],
