// Rogue Defeat S5 — base hero, board stage 5, boss defeat ending.
// Run: node src/playables/board-fight/scripts/codegen.js m5_board_defeat_rollsSurvived
...
module.exports = {
  ...
  fights: {
    // Fight 1: Single desert hornet — easy intro, player dominates
    hornetIntro: {
      background: 'stage5',
      enemies: [
    ...
    // Fight 2: 3 mummy warriors — mid difficulty, player drops to ~50% HP
    ...
    // Fight 3: Elite — bastet at middle, desert hornets at top/bottom
    // Player rage: 20+15+15+15+20+15 = 100
    bastetElite: {
      background: 'stage5',
      eliteFight: true,
      ...
      steps: [
        ...
        // Round 4: finish bastet with rage
    ...
    // Boss fight: anubis at middle, mummy warriors at top/bottom
    // Anubis rage: 50+50 = 100 (1 rage attack)
    ...
    bossDefeat: {
      ...
      steps: [
        // Round 1: aggressive opener -> skill -> enemies respond -> clear mummy 1
        ...
        { type: 'die', actor: 1 },
        // Round 2: anubis punishes, clear mummy 2
        ...
        // Round 4: anubis finishes the player
