// Rogue Victory S3 — base hero, board stage 3, boss victory, nextChapter ending.
// Run: node src/playables/board-fight/scripts/codegen.js m3_board_victory_rollsSurvived
...
module.exports = {
  ...
  fights: {
    // Fight 1: Single cave spider — easy intro, player dominates
    spiderIntro: {
      background: 'stage3',
      enemies: [
    ...
    // Fight 2: 3 red shrooms — mid difficulty, player drops to ~50% HP
    shroomSwarm: {
      background: 'stage3',
      enemies: [
