// Rogue Victory S3 FightsOnly — same as rogueVictoryS3 but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m3_fight_victory_rollsSurvived
