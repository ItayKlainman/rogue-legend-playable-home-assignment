// Rogue Victory S2 — base hero, board stage 2, boss victory, nextChapter ending.
// Run: node src/playables/board-fight/scripts/codegen.js m2_board_victory_rollsSurvived
...
module.exports = {
  ...
  fights: {
    ...
    // Fight 2: 3 goblin mages — mid difficulty, player drops to ~50% HP
    goblinMageSwarm: {
      background: 'stage2',
      enemies: [
    ...
    // Boss fight: victory — ogre + 2 goblin mages
    bossVictory: {
      background: 'stage2',
      bossFight: true,
      enemies: [
