// Rogue Victory variant — base hero, board stage 1, boss victory ending.
// Run: node src/playables/board-fight/scripts/codegen.js m1_board_victory_rollsSurvived
...
module.exports = {
  ...
  fights: {
    ...
    // King rage: 50+50 = 100 (1 rage attack)
    // Player rage: 15+15+15+15+20+20 = 100
    // King melee-only damage: 35+55+50+80 = 220K exact match
    bossVictory: {
      bossFight: true,
      enemies: [
      ...
      steps: [
        // Round 1: aggressive opener → skill → enemies respond → clear slime 1
