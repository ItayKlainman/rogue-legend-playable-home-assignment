// Rogue Victory FightsOnly — same as rogueVictory but no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m1_fight_victory_rollsSurvived
...
module.exports = {
  ...
  fights: {
    ...
    // Fight 3: Elite — commander at middle, skeletons at top/bottom
    elitePatrol: {
      eliteFight: true,
      enemies: [
    ...
    // Boss fight: king + 2 slimes, player wins
    bossVictory: {
      bossFight: true,
      enemies: [
