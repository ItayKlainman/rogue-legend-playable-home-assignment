// Rogue Victory S2 GameEnd FightsOnly — no board, fights-only with progress bar.
// Run: node src/playables/board-fight/scripts/codegen.js m2_fight_victory_splash
